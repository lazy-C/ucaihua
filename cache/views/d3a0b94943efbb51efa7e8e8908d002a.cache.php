...
<div class="col-2 lf mr10" style="width:48%">
	...
	<div class="content">
		...
		<?php if (is_array($model)) { $count=count($model);foreach ($model as $t) { ?>
		  <tr>
			<td width="261"><?php echo $t['modelname']; ?>：&nbsp;<a href="<?php echo url('admin/content/', array('modelid'=>$t['modelid'])); ?>"><span id="m_<?php echo $t['modelid']; ?>_1"><img src="<?php echo ADMIN_THEME; ?>images/onLoad.gif"></span></a></td>
