...
$(document).ready(function(){
	...
	$("#nav-more").click(function(){
		...
		$.post("<?php echo url('api/mobiledata'); ?>&rand="+Math.random(), { tpl: "data_index", page:id }, function(data){ 
			$("#deals").append(data);
...
<div class="current-category">您当前的位置：首页</div>
<div id="deals">
    <input name="list_id" id="list_id" type="hidden" value="1">
    <?php include $this->_include('data_index'); ?>
</div>
