...
<div id="banner">
    ...
    <div id="frame">
        <div id="img"> 
        	<a href='' style="width:100%; height:425px; background:url(<?php echo SITE_THEME; ?>images/benna/index_3.jpg) no-repeat center top;"></a>
        	<a href='' style="width:100%; height:425px; background:url(<?php echo SITE_THEME; ?>images/benna/index_2.jpg) no-repeat center top;"></a>
        	<a href='' style="width:100%; height:425px; background:url(<?php echo SITE_THEME; ?>images/benna/index_1.jpg) no-repeat center top;"></a>
        </div>
        <div id="btn">
				<span><a id="btn01">&nbsp;</a><i><img src="<?php echo SITE_THEME; ?>images/benna/01on.png" width="128" height="98" /></i></span>
				<span><a id="btn02">&nbsp;</a><i><img src="<?php echo SITE_THEME; ?>images/benna/02on.png" width="128" height="98" /></i></span>
				<span><a id="btn03">&nbsp;</a><i><img src="<?php echo SITE_THEME; ?>images/benna/03on.png" width="128" height="98" /></i></span>
        </div>
    </div>
    <!--end幻灯-->
</div>
...
<!--内容主体 开始-->
<div id="wrap">
	<div class="cbody960 clearfix">
		<div id="gyzc">
 			<div class="moer"><a href="index.php?c=content&a=show&id=43"><img src="<?php echo SITE_THEME; ?>images/moer.jpg" width="53" height="16" /></a></div>
            <ul>
            	<?php $return = $this->_listdata("catid=21 order=updatetime num=4 cache=36000"); extract($return); $count=count($return); if (is_array($return)) { foreach ($return as $key=>$t) { ?>
                <li><span class="extra">[<?php echo date("Y-m-d", $t['updatetime']); ?>]</span><a href="<?php echo $t['url']; ?>" title="<?php echo $t['title']; ?>"><?php echo strcut($t['title'],32,''); ?></a></li>
                <?php } } ?>
      		</ul>
		</div>

		<div id="news">
			<div class="moer"><a href="index.php?c=content&a=list&catid=21"><img src="<?php echo SITE_THEME; ?>images/moer.jpg" width="53" height="16" /></a></div>
			<ul>
            	<?php $return = $this->_listdata("catid=23 order=updatetime num=4 cache=36000"); extract($return); $count=count($return); if (is_array($return)) { foreach ($return as $key=>$t) { ?>
                <li><span class="extra">[<?php echo date("Y-m-d", $t['updatetime']); ?>]</span><a href="<?php echo $t['url']; ?>" title="<?php echo $t['title']; ?>"><?php echo strcut($t['title'],32,''); ?></a></li>
                <?php } } ?>
      		</ul>
		</div>
		<div class="weibo">
			<div class="weibo1"><a href="index.php?c=content&a=list&catid=59"> <p style="padding-top:30px; margin-left:10px; color:#09F;">&nbsp;</p></a></div>
			<div class="blank10"></div>
			<div class="weibo2"><a href="index.php?c=content&a=list&catid=60"><p style="padding-top:12px; margin-left:24px; line-height:16px; color:#333;">&nbsp;</p></a></div>
			<div class="weibo3"><a href="#" class="weibotx">腾讯微博</a> <a href="http://www.weibo.com/pccn" class="weiboxl" target="_blank">新浪微博</a> </div>
		</div>
	</div>
...
<div id="wrap" style="display:none;">
    ...
    <script type="text/javascript" src="<?php echo SITE_THEME; ?>css/common.js"></script>
