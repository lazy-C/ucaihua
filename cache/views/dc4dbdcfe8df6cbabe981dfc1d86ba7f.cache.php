		...
		<div class="pad-10">
			<div class="col-tab">
				<ul class="tabBut cu-li">
					<li onClick="SwapTab('setting','on','',2,1);" class="<?php if ($typeid==1) { ?>on<?php } ?>" id="tab_setting_1"><?php echo lang('a-men-12'); ?></li>
					<li onClick="SwapTab('setting','on','',2,2);" id="tab_setting_2" class="<?php if ($typeid==2) { ?>on<?php } ?>"><?php echo lang('a-men-13'); ?></li>
				</ul>
				...
				<tr>
					...
					<td><input class="input-text" type="text" name="data[SITE_TITLE]" value="<?php echo $data['SITE_TITLE']; ?>" style="width:450px;" /></td>
				</tr>
				<tr>
					<th><?php echo $string['SITE_KEYWORDS']; ?>：</th>
					<td class="y-bg"><textarea name="data[SITE_KEYWORDS]" style="width:510px;height:30px;" class="text"><?php echo $data['SITE_KEYWORDS']; ?></textarea></td>
				</tr>
				<tr>
					<th><?php echo $string['SITE_DESCRIPTION']; ?>：</th>
					<td><textarea name="data[SITE_DESCRIPTION]" style="width:510px;height:40px;" class="text"><?php echo $data['SITE_DESCRIPTION']; ?></textarea></td>
				</tr>
				</table>
				</div>
