	...
	<div class="pad-10">
		<div class="col-tab">
			<ul class="tabBut cu-li">
				<li onClick="SwapTab('setting','on','',5,1);" id="tab_setting_1" class="<?php if ($type==1) { ?>on<?php } ?>"><?php echo lang('a-men-65'); ?></li>
				<li onClick="SwapTab('setting','on','',5,2);" id="tab_setting_2" class="<?php if ($type==2) { ?>on<?php } ?>"><?php echo lang('a-men-14'); ?></li>
				<li onClick="SwapTab('setting','on','',5,3);" id="tab_setting_3" class="<?php if ($type==3) { ?>on<?php } ?>"><?php echo lang('a-men-15'); ?></li>
				<li onClick="SwapTab('setting','on','',5,4);" id="tab_setting_4" class="<?php if ($type==4) { ?>on<?php } ?>"><?php echo lang('a-men-16'); ?></li>
				<li onClick="SwapTab('setting','on','',5,5);" id="tab_setting_5" class="<?php if ($type==5) { ?>on<?php } ?>"><?php echo lang('a-men-17'); ?></li>
			</ul>
			...
			<tbody>
				<tr>
					<th width="200"><?php echo $string['SITE_ADMINLOG']; ?>： </th>
