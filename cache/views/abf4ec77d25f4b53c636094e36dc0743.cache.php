...
<div class="subnav">
	...
	<div class="table-list">
		...
		<tr >
			...
			<input <?php if (!admin_auth($userinfo['roleid'], 'tag-del')) { ?>disabled<?php } ?> type="submit" class="button" value="<?php echo lang('a-del'); ?>" name="submit_del" onClick="$('#list_form').val('del');return confirm_del()" />&nbsp;
			<input <?php if (!admin_auth($userinfo['roleid'], 'tag-edit')) { ?>disabled<?php } ?> type="submit" class="button" value="<?php echo lang('a-gx'); ?>" name="submit_update" onClick="$('#list_form').val('update')" />&nbsp;
