...
<div class="subnav">
	<div class="table-list">
		...
		<tbody>
		<tr><td align="left"><?php echo lang('a-att-4'); ?>：<?php echo $dir; ?></td></tr>
		<?php if ($istop) { ?>
		<tr><td align="left"><a href="<?php echo $pdir; ?>"><img src="<?php echo ADMIN_THEME; ?>images/folder-closed.gif"><?php echo lang('a-att-5'); ?></a></td></tr>
		<?php }  if (is_array($list)) { $count=count($list);foreach ($list as $k=>$t) { ?>
		<tr>
		<td align="left" onclick="<?php if (!$t['url']) { ?>album_cancel(this)<?php } ?>">
		<img src="<?php echo ADMIN_THEME; ?>images/ext/<?php echo $t[ico]; ?>">
